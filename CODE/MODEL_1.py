...
def cm_analysis(Y_Test, y_pred, labels, name, ymap=None, figsize=(10,10)):
    """
...
for name, model1 in models:
    ...
    #print("AUC : ",roc_auc_score(y_score=test_pred1, y_true=Y_Test, multi_class="ovr",average=None))
